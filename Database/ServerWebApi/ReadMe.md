...
If the ports are open or if you just run the command above, the find the direction where you put the project. Here it is: /home/pi/deployment-location/
```bash
dotnet ServerWebApi.dll
```
Ports: https://10.77.77.77:5001/{Endpoint}